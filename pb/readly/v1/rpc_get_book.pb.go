...
// 	protoc        (unknown)
// source: readly/v1/rpc_get_book.proto
...
func (x *GetBookRequest) Reset() {
	*x = GetBookRequest{}
	mi := &file_readly_v1_rpc_get_book_proto_msgTypes[0]
...
func (*GetBookRequest) Descriptor() ([]byte, []int) {
	return file_readly_v1_rpc_get_book_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_readly_v1_rpc_get_book_proto_rawDescOnce sync.Once
	file_readly_v1_rpc_get_book_proto_rawDescData []byte
)

func file_readly_v1_rpc_get_book_proto_rawDescGZIP() []byte {
	file_readly_v1_rpc_get_book_proto_rawDescOnce.Do(func() {
		file_readly_v1_rpc_get_book_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_readly_v1_rpc_get_book_proto_rawDesc), len(file_readly_v1_rpc_get_book_proto_rawDesc)))
	})
...
func file_readly_v1_rpc_get_book_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_readly_v1_rpc_get_book_proto_goTypes,
		DependencyIndexes: file_readly_v1_rpc_get_book_proto_depIdxs,
		MessageInfos:      file_readly_v1_rpc_get_book_proto_msgTypes,
	}.Build()
	File_readly_v1_rpc_get_book_proto = out.File
	file_readly_v1_rpc_get_book_proto_goTypes = nil
	file_readly_v1_rpc_get_book_proto_depIdxs = nil
}
