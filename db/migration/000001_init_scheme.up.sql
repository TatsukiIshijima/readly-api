...
COMMENT ON TABLE "books" IS 'Stores book data.';

COMMENT ON TABLE "authors" IS 'Stores author data.';

COMMENT ON TABLE "publishers" IS 'Stores publisher data.';

COMMENT ON TABLE "genres" IS 'Stores genre data.';

COMMENT ON TABLE "book_genres" IS 'Stores book and genre. Normalize using intermediate tables because of the many-to-many relationship between books and genres.';

COMMENT ON TABLE "reading_histories" IS 'Stores reading history.';
...
ALTER TABLE "reading_histories" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "reading_histories" ADD FOREIGN KEY ("book_id") REFERENCES "books" ("id");
